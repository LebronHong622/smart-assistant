...
@tool
def document_retrieval(query: str, limit: int = 5, score_threshold: float = 0.5) -> dict:
    """
...
@tool
def retrieve_similar_documents_by_embedding(embedding: list[float], limit: int = 5, score_threshold: float = 0.5) -> dict:
    """
    根据嵌入向量检索相似文档
